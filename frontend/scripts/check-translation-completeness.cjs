...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'COMMON$GIT_PUSH',
  'COMMON$JUPYTER',
  'COMMON$MODEL_CONTEXT_PROTOCOL_MCP',
  'COMMON$PLAN_MD',
  'SETTINGS$PRO_PILL',
  'HOOK$STDERR',
  'SETTINGS$PLUGINS_REF_LABEL',
  ...
  'SCHEMA$LLM$API_MODE$CHOICE$AUTO',
  'SCHEMA$LLM$API_MODE$CHOICE$CHAT',
  'SCHEMA$LLM$API_MODE$CHOICE$RESPONSES',
