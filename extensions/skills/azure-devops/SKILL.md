---
name: azure-devops
description: Взаимодействие с репозиториями Azure DevOps, пулл-реквестами и API через переменную окружения AZURE_DEVTOPS_TOKEN. Используй при работе с кодом, размещённым в Azure DevOps, или при управлении ресурсами Azure DevOps.
triggers:
- azure_devops
- azure
---
