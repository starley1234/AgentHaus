---
name: ssh
description: Установка и управление SSH-подключениями к удалённым машинам, включая генерацию ключей, настройку и передачу файлов. Используй при подключении к удалённым серверам, выполнении удалённых команд или передаче файлов по SCP.
triggers:
- ssh
- remote server
- remote machine
