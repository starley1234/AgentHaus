---
name: linear
description: Взаимодействие с проектным менеджментом Linear — запрос задач, обновление статуса, создание тикетов и управление рабочими процессами через Linear GraphQL API. Используй при работе с тикетами, спринтами или отслеживанием проектов Linear.
triggers:
- linear
- ticket
- issue tracking
