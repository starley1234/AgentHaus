...
description: Этот навык следует использовать, когда пользователь просит «синхронизировать форк», «перебазировать локальные изменения на апстрим», «синхронизировать форк ночью», «долгоживущий форк» или «автоматизировать rebase апстрима». Помогает пользователю настроить такую автоматизацию.
triggers:
