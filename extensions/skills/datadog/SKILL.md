---
name: datadog
description: Запрос и анализ логов, метрик, APM-трейсов и мониторов Datadog через Datadog API. Используй при отладке проблем в продакшене, мониторинге производительности приложений или разборе алертов.
triggers:
- datadog
---
