...
description: Создание автоматизации, которая готовит ретроспективы инцидентов. Собирает сообщения из каналов инцидентов Slack, подтягивает связанные тикеты и follow-up из Linear и публикует черновик ретроспективы в Notion с таймлайном и чек-листом.
triggers:
