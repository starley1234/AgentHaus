---
name: discord
description: Создание и автоматизация интеграций Discord (боты, вебхуки, слэш-команды и REST API рабочие процессы). Используй, когда пользователь упоминает Discord, сервер/гильдию Discord, каналы, вебхуки, токены ботов, слэш-команды/application commands, discord.js или discord.py.
triggers:
  - discord
  - discord api
  - discord bot
