...
description: Особенности Bitbucket Data Center (self-hosted Bitbucket Server) — аутентификация через BITBUCKET_DATA_CENTER_TOKEN, REST API 1.0, репозитории вида PROJECT/repo_slug, git-remotes scm/ и инструмент create_bitbucket_data_center_pr. Загружается по требованию навыком bitbucket при обнаружении окружения Data Center.
---
