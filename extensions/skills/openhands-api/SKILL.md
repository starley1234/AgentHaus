---
name: openhands-api
description: Справочный навык для OpenHands Cloud REST API (V1) и agent-server API, включая запуск дополнительных облачных или локальных бэкенд-диалогов для работы со свежим контекстом или делегирования.
triggers:
- openhands-api
- openhands-api-v1
- openhands-cloud
