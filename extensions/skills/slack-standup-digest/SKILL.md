...
description: Создание автоматизации, которая генерирует асинхронный дайджест стендапа из Slack. Ищет сообщения в выбранных каналах с прошлого рабочего дня, группирует обновления по проектам, выделяет блокеры и решения и публикует сводку.
triggers:
