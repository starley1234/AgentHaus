...
description: Этот навык следует использовать, когда пользователь просит «создать автоматизацию», «запланировать задачу», «настроить cron-задачу», «интеграцию с вебхуком», «событийную автоматизацию» или упоминает автоматизации, плановые задачи, cron-планирование или вебхук-события в OpenHands Cloud.
triggers:
- automation
- automations
- scheduled task
