---
name: notion
description: Создание, поиск и обновление страниц и баз данных Notion через Notion API. Используй для документирования работы, генерации runbook'ов и автоматизации обновлений базы знаний.
triggers:
- notion
---
