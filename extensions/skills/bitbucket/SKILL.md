---
name: bitbucket
description: Хаб интеграций Bitbucket. Определяет, находится ли репозиторий в Bitbucket Cloud или Bitbucket Data Center, и направляет в соответствующий детальный навык (bitbucket-cloud или bitbucket-data-center). Используй для любых задач с репозиторием или пулл-реквестом Bitbucket.
triggers:
- bitbucket
---
