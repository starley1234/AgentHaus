...
description: Особенности Bitbucket Cloud (bitbucket.org) — аутентификация через BITBUCKET_TOKEN, REST API v2, репозитории вида workspace/repo_slug и инструмент create_bitbucket_pr. Загружается по требованию навыком bitbucket при обнаружении облачного окружения.
---
