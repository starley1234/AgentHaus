---
name: vercel
description: Деплой и управление приложениями на Vercel, включая preview-деплои и защиту деплоев. Используй при работе с проектами, размещёнными на Vercel, или при настройке деплоев Vercel.
triggers:
- vercel
- preview deployment
---
