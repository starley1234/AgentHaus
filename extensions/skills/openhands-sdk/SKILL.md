---
name: openhands-sdk
description: Справочный навык для OpenHands Software Agent SDK — Python-фреймворка для создания ИИ-агентов, пишущих код. Используй, когда нужно создавать агентов на SDK, делать кастомные инструменты, настраивать LLM, управлять диалогами.
triggers:
- openhands-sdk
- openhands sdk
- software-agent-sdk
