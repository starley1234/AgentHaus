---
name: linear-triage
description: Создание автоматизации, которая проводит триаж новых задач Linear. Изучает заголовок, описание, команду, клиента, приоритет и недавние связанные задачи через Linear MCP. Предлагает метки, приоритет, вероятного владельца, дубликаты и публикует результаты.
triggers:
  - /linear-triage:setup
---
