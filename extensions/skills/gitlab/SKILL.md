---
name: gitlab
description: Взаимодействие с репозиториями GitLab, merge-реквестами и API через переменную окружения GITLAB_TOKEN. Используй при работе с кодом, размещённым в GitLab, или при управлении ресурсами GitLab.
triggers:
- gitlab
---
