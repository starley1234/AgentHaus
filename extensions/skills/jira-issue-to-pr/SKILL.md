...
description: Этот навык следует использовать, когда пользователь просит «настроить автоматизацию Jira для создания пулл-реквестов», «опрашивать Jira на предмет задач create-pr», «автоматически создавать GitHub PR из тикетов Jira», «развернуть автоматизацию issue-to-PR в Jira», «создать рабочий процесс Jira в GitHub PR».
---
