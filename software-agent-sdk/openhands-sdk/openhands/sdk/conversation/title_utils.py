                ...
                content=[
                    TextContent(
                        text=(
                            ...
                            "Write the title in the SAME LANGUAGE as the user "
                            "message; if the language is ambiguous or mixed, "
                            "write the title in Russian. Return only "
                ...
                content=[
                    TextContent(
                        text=(
                            ...
                            "above (Russian message → Russian title). "
