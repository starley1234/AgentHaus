...
- Прохождение CAPTCHA в браузере (координаты мыши/клика): [`docs/CAPTCHA_BROWSER_RU.md`](docs/CAPTCHA_BROWSER_RU.md) и [`extensions/skills/web-captcha/README.md`](extensions/skills/web-captcha/README.md)
